...
export const translations: Record<string, Record<string, string>> = {
	en: {
		...
		'work.coming-soon.title': 'Coming Soon',
		'work.coming-soon.description': 'Work in progress',
	...
	es: {
		...
		'work.coming-soon.title': 'Próximamente',
		'work.coming-soon.description': 'Trabajo en progreso',
